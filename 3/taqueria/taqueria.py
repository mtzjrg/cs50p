# Felipe's Taqueria: Implement a program that enables a user to place an order,
#       prompting them for items, one per line, until the user inputs control-d
#       (which is a common way of ending one's input to a program). After each
...
#       Treat the user's input case insensitively. Ignore the input that isn't
