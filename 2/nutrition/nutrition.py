# Nutrition Facts: Implement a program that prompts users to input a fruit and
#           then outputs the number of calories in one portion of that fruit,
#           per the FDA's poster for fruits (also available in text)
...
#           as written in the poster. Ignore any input that isn't a fruit
